...
data1 = pd.get_dummies(data1, columns=['Gender', 'Occupation', 'BMI Category', 'Sleep Disorder',"Blood Pressure"], drop_first=True)
...
model_names = ['Régression Logistique', 'Réseau de Neurones', 'KNN']
colors = ['blue', 'orange', 'green']

# Liste pour stocker les précisions
accuracies = [accuracy0, accuracy1, accuracy2]
...
# Afficher les précisions sur une courbe
plt.figure(figsize=(10, 6))
